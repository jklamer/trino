        ...
        implements HivePageSourceFactory
{
            ...
            AcidTransaction transaction)
    {
        ...
        if (maskedSchema.getFields().isEmpty()) {
            ...
            try {
                return Optional.of(noProjectionAdaptation(new AvroHivePageSource(inputFile, nullSchema.endRecord(), new HiveAvroTypeManager(), start, length)));
            }
            catch (IOException e) {
        ...
        try {
            return Optional.of(new ReaderPageSource(new AvroHivePageSource(inputFile, maskedSchema, new HiveAvroTypeManager(), start, length), readerProjections));
        }
        catch (IOException e) {
            throw new TrinoException(HIVE_CANNOT_OPEN_SPLIT, e);
        }
