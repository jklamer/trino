        ...
        implements Closeable
{
            ...
            throws IOException, AvroTypeException
    {
        ...
        try {
            ...
            // Avro Dataum Reader interface can't throw checked exceptions when initialized by the file reader,
    ...
    private void loadNextPageIfNecessary()
            throws IOException
    {
        while (Objects.isNull(nextPage) && (end.isEmpty() || !fileReader.pastSync(end.getAsLong())) && fileReader.hasNext()) {
            try {
